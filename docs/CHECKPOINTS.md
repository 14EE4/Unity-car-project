...
- 프로젝트에서는 V자형 체크포인트 모델과 주행 안내 화살표 프리팹에 작성자가 직접 제작한 머티리얼을 적용합니다. 특히 체크포인트에는 **초록색 반투명 머티리얼**을 적용하여 트랙과 시각적으로 조화를 이루면서도 통과 지점을 명확히 보여주도록 설정되어 있습니다. 화살표 프리팹에는 주행 유도용 **초록색**과 진입 금지용 **빨간색** 머티리얼이 적용되어야 합니다 (씬이나 프리팹에서 확인 및 변경 가능).
