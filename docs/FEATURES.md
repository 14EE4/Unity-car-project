...
- 체크포인트 기반 완주 판정
- 완주 후에는 랩 타임과 체크포인트가 잠기며, `R` 리셋 또는 메뉴 재진입 / 재시작으로만 다음 시도가 시작됩니다.
- 체크포인트는 올바른 순서로 통과하면 비활성화되어 화면에서 사라지고, 리셋 시 다시 활성화됩니다
- 공통 로딩 화면을 통한 씬 전환
...
- 랩 타임 HUD는 완주 후 "Lap complete..." 안내 문구를 표시해 현재 시도가 잠겨 있음을 알려줍니다.
